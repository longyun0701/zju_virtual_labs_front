...
export function Activities({lang}) {
    ...
    return (
      <div>
        ...
        <tr>
          <td width="50%">
            <img src={prePath+"textbook_cover.jpg"} width="500" height="340" alt="textbook"/> 
          </td>
          <td width="50%"  class="fac_intro_text">
            &nbsp;&nbsp;&nbsp;&nbsp;{text_intro_1}
            <br/><br/>
            &nbsp;&nbsp;&nbsp;&nbsp;{text_intro_2} 
          </td>
        ...
        <br/>
        <br/>
          <a  class="highlight_shift" href={prePath+"text_intro.pdf"}>{dl_text}</a>
        <br/>
      </div>
    )
  }
